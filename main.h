 ...
 * @space_flag: on hashtag_flag specified
 ...
 *
 * @h_modifier: on if h_modifer is specified
 * @l_modifier: on if l_modifer is specified
 *
 */
...
int print_rot14(va_list ap, params_t *params);
