...
/**
 * convert_size_number - appends a number to the specified size
 * @num: Number to be appended.
 * @size: Number indicating the type to be appended.
 *
 * Return: Appended value of num
 */
